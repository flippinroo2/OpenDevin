...
DEFAULT_MODEL_NAME = DEFAULT_CONFIG.get("LLM_MODEL")
DEFAULT_LLM_PROVIDER = DEFAULT_CONFIG.get("LLM_PROVIDER")
DEFAULT_LLM_NUM_RETRIES = DEFAULT_CONFIG.get("LLM_NUM_RETRIES")
DEFAULT_LLM_COOLDOWN_TIME = DEFAULT_CONFIG.get("LLM_COOLDOWN_TIME")
PROMPT_DEBUG_DIR = DEFAULT_CONFIG.get("PROMPT_DEBUG_DIR")
            ...
            model_list=[
                {
                    ...
                    "litellm_params": {
                        ...
                        "custom_llm_provider": DEFAULT_LLM_PROVIDER,
                    },
                }
            ],
